...
ip link set address 00:c1:ab:00:00:13 dev bond0
ip link set address 00:c1:ab:00:00:14 dev bond1
ip addr add 192.168.0.13/24 dev bond0
...
ip addr add 192.168.1.14/24 dev bond1.10
